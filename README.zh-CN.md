...
[Releases 页面](https://github.com/tiangong-dev/pawl/releases)上的每个压缩包都用 [cosign](https://github.com/sigstore/cosign) 做了 keyless 签名；如果你不走 npm、Go 或 `install.sh`，而是手动下载，先校验一下：
