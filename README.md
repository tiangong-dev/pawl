...
<p align="center">
  ...
  <a href="https://scorecard.dev/viewer/?uri=github.com/tiangong-dev/pawl"><img src="https://api.scorecard.dev/projects/github.com/tiangong-dev/pawl/badge" alt="OpenSSF Scorecard"></a>
...
- uses: tiangong-dev/pawl@v0       # puts the pawl binary on PATH — no Go/Node
  with:
    version: v0.8.0                # optional; defaults to the latest release
- run: pawl check
...
Run `npx -y @pawl-tools/cli@0.8.0 check` (or download the release binary) in any
